...
// Đếm tổng
$stmt_count = $db->prepare("SELECT COUNT(*) as total FROM san_pham sp JOIN loai_sp l ON sp.ma_loai = l.ma_loai $where");
...
<main class="main">
  <div class="page-title light-background">
    <div class="container d-lg-flex justify-content-between align-items-center">
      <h1 class="mb-2 mb-lg-0">Thương hiệu: <?= htmlspecialchars($ten_loai) ?></h1>
          ...
          <div class="product-categories-widget widget-item">
            ...
            <ul class="category-tree list-unstyled mb-0">
                ...
                <div class="d-flex justify-content-between align-items-center category-header">
                  <a href="brand.php?ma_loai=<?= $loai['ma_loai'] ?>"
                    ...
                    <input class="form-check-input" type="radio"
                           <?= $ma_loai == $loai['ma_loai'] ? 'checked' : '' ?> readonly>
                    <label class="form-check-label"><?= htmlspecialchars($loai['ten_loai']) ?></label>
                  </a>
                </div>
              </li>
              <?php endwhile; ?>
              ...
              <li class="category-item mt-2">
                <a href="brand.php" class="text-muted small">✕ Xem tất cả thương hiệu</a>
              </li>
              <?php endif; ?>
            </ul>
          </div>
                  ...
                  <div class="row g-2">
                    <div class="col-6">
                      <div class="input-group input-group-sm">
                        ...
                        <input type="number" name="gia_min" class="form-control"
                               placeholder="Min" value="<?= $gia_min ?>">
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="input-group input-group-sm">
                        <span class="input-group-text">VND</span>
                        <input type="number" name="gia_max" class="form-control"
                               placeholder="Max" value="<?= $gia_max < 100000000 ? $gia_max : '' ?>">
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="brand-filter-content">
              <div class="brand-list">
                ...
                foreach ($sorts as $k => $v):
                    $url = "brand.php?sort=$k" .
                           ($ma_loai ? "&ma_loai=$ma_loai" : '') .
                           ($gia_min ? "&gia_min=$gia_min" : '') .
                           ($gia_max < 100000000 ? "&gia_max=$gia_max" : '');
                ?>
                <div class="brand-item">
                  <div class="form-check">
                    <input class="form-check-input" type="radio" id="sort_<?= $k ?>"
                           <?= $sort == $k ? 'checked' : '' ?>
          ...
          <div class="container" data-aos="fade-up" data-aos-delay="100">
            <div class="row">
              ...
              <div class="col-12 text-center py-5">
                ...
                <a href="brand.php" class="btn btn-primary mt-2">Xem tất cả</a>
              </div>
              <?php endif; ?>
            </div>
          </div>
